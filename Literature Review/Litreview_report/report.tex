...
\textcolor{red}{ Also, a number of different classifier techniques were applied on labeled datasets. Although they often achieve good accuracy in the DARPA'98 or KDD'99 datasets, it is unclear how well they translate. Should I include papers using classifiers}
...
\textcolor{red}{hidden markov models for system calls - two papers}
