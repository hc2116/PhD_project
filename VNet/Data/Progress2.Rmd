...
- 13:29 Login to Kali Linux
- 13:31 Open browser to file:///usr/share/kali-defaults/web/homepage.html
- 13:33 Open facebook
- 13:34 log-in to facebook
- 13:35 close browser
- open empty window
- 13:36 open facebook directly logged-in
- 13:37 scroll to the bottom to reload
...
```{r Facebook,eval=TRUE,cache=FALSE,fig.height=50,fig.width=15,echo=FALSE}
window <- c(0,500)+48606
