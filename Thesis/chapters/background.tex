...
\begin{tabular}{p{2.5cm}|p{3cm}|p{2.3cm}|p{2cm}|p{3.5cm}}
Dataset&Format&\#hosts & Duration & Source\\ \hline
CICIDS-18& Pcap+ML-flows (80 features) & 30 & 5 days &Synthetic (VM+scripts) \\\
\end{tabular}
