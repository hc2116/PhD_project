...
\begin{figure}
 \centering 
 \includegraphics[width=0.480\textwidth]{images_DYNAMICS/scenario_branching.PNG}
...
\begin{figure}%[h!]
\centering
\includegraphics[width=0.49\textwidth]{images_DYNAMICS/ftp_new1.png}
...
\begin{figure}
\includegraphics[width=0.45\textwidth]{images_DYNAMICS/combined3.png} % first figure itself
...
\centering
\includegraphics[width=0.45\textwidth]{images_DYNAMICS/1-plot_exp1.png}
...
\subfloat{%
 \includegraphics[width=0.4\textwidth]{images_DYNAMICS/bw_100_exp_3.png}
}

\subfloat{
 \includegraphics[width=0.4\textwidth]{images_DYNAMICS/bw_500_exp_3.png}
}
