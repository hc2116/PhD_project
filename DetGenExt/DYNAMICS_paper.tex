...
\begin{figure}
 \centering 
 \includegraphics[width=0.480\textwidth]{ACSAC_DYNAMICS/images/scenario_branching.PNG}
...
\begin{figure}%[h!]
\centering
\includegraphics[width=0.49\textwidth]{ACSAC_DYNAMICS/images/ftp_new1.png}
...
\begin{figure}
\includegraphics[width=0.45\textwidth]{ACSAC_DYNAMICS/images/combined3.png} % first figure itself
...
%\begin{figure*}
%\centering
%\includegraphics[width=0.8\textwidth]{ACSAC_DYNAMICS/images/ftp_new2.png}
...
\centering
\includegraphics[width=0.45\textwidth]{ACSAC_DYNAMICS/images/1-plot_exp1.png}
...
%\begin{figure*}
%\begin{multicols}{2}
%\includegraphics[width=linewidth]{ACSAC_DYNAMICS/images/primary_prec.png} % first figure itself
...
\subfloat{%
 \includegraphics[width=0.4\textwidth]{ACSAC_DYNAMICS/images/bw_100_exp_3.png}
}

\subfloat{
 \includegraphics[width=0.4\textwidth]{ACSAC_DYNAMICS/images/bw_500_exp_3.png}
}
