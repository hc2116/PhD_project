...
In particular, we look at a \textit{Long-short-term memory} (LSTM) network \footnote{a deep learning design for sequential data} by Hwang et al. \cite{hwang2019lstm}, which is designed to classify attacks in web traffic. Through probing we will see, retransmission sequences in a packet sequence deplete the models classification accuracy. We 
