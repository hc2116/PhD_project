...
\begin{enumerate}
\item We demonstrate how to generate probing traffic that is suitable to probe models pre-trained on a 
NIDS-dataset.
...
\item We probe a state-of-the-art LSTM traffic classifier with this traffic dataset, and demonstrate how to lower false-positives effectively by understanding where the model fails to process particular traffic structures correctly.
