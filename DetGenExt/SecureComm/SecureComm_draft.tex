...
\item \textbf{Application layer protocols}: We used the same range of protocols that occur in the CICIDS datasets, namely \textit{HTTP/SSL, SMTP, FTP, SSH, and NTP}. 

\item \textbf{Implementations}: For each of the protocols, we used similar application implementations, such as Apache for HTTP-activities ...
