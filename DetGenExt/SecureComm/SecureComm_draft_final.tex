...
\begin{figure}
\centering
\includegraphics[width=0.99\textwidth]{images/LSTM_classi_sigmoid.png}
...
\begin{figure}
\centering
\includegraphics[width=0.95\textwidth]{images/LSTM_activation_new_sigmoid.png}
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{images/FTP_load_new.png}
