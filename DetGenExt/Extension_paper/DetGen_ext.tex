...
\title{How to make traffic generation and monitoring at packet level more dynamic using containerisation}
...
\begin{enumerate}
\item We present a novel network traffic generation framework that is designed to improve several shortcomings of current datasets and data generation frameworks for NIDS evaluation in the following aspects:
\begin{enumerate}
