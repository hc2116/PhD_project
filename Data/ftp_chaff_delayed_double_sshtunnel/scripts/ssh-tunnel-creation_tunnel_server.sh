...
echo "Creating server-tunnel"
sshpass -p $PASS ssh -4 -o StrictHostKeyChecking=no -L \*:7777:$FTP_SERVER:21 -L \*:7778:$FTP_SERVER:20 -L \*:18:$NETCAT_SERVER:18 -L \*:17:$NETCAT_SERVER:17 root@$SERVER -f -N
#sleep 1
