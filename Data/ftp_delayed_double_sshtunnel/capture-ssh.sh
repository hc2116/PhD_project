...
do
    ...
    sleep 5
    $PWD/scripts/container_tc.sh ftp_delayed_double_sshtunnel_ftp_client_1 5 0.01
    $PWD/scripts/container_tc.sh ftp_delayed_double_sshtunnel_ssh_client_1 5 0.01
    $PWD/scripts/container_tc.sh ftp_delayed_double_sshtunnel_ftp_server_1 5 0.01
    $PWD/scripts/container_tc.sh ftp_delayed_double_sshtunnel_ssh_server_1 5 0.01
    $PWD/scripts/container_tc.sh ftp_delayed_double_sshtunnel_ssh_tunnel_1_1 5 0.01
    echo "Keyscanning"
    keyscanning;
