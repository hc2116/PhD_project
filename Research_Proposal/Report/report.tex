...
\caption{}
\end{subfigure}
\caption{The left plot depicts simple anomalies that deviate in distance from regular data. The right plot shows a contextual anomaly where a group of data instances do not follow a repeating timely behaviour with respect to all other data points (corresponding to a \textit{Atrial Premature Contraction}, taken from \cite{chandola_anomaly_2009})}
\end{figure}
