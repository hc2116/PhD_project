...
class QuotesSpider(scrapy.Spider):
	name = "quotes"
	urls = ["""https://www.dapurpendidikan.com""",
			"""https://www.apteka66plus.ru""",
			"""https://www.prodeco-company.ru"""] #define the start URL you want to start your crawl from
	#urls = [sys.argv[1]]
	pages = []
	...
	def start_requests(self):
		...
		#		print(url)
				yield scrapy.Request(url=url, 
					callback=self.parse, 
					dont_filter=True, 
					meta={"proxy": "http://172.53.238.7:7777"},
	...
	def parse(self, response):
		...
		# 			meta={"proxy": "http://172.53.238.1:3128"},
		# 			headers={"User-Agent": "My UserAgent"})
