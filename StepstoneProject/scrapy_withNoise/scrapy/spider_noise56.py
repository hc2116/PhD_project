...
class QuotesSpider(scrapy.Spider):
	name = "quotes"
	urls = ["""https://www.karas4training.com""",
			"""https://www.adams.edu""",
			"""https://www.s54s.com"""] #define the start URL you want to start your crawl from
	#urls = [sys.argv[1]]
	pages = []
	...
	def start_requests(self):
		...
		#		print(url)
				yield scrapy.Request(url=url, 
					callback=self.parse, 
					dont_filter=True, 
					meta={"proxy": "http://172.56.238.7:7777"},
	...
	def parse(self, response):
		...
		# 			meta={"proxy": "http://172.56.238.1:3128"},
		# 			headers={"User-Agent": "My UserAgent"})
