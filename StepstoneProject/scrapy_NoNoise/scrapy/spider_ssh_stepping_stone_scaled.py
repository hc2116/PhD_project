...
class QuotesSpider(scrapy.Spider):
	name = "quotes"
	urls = ["""https://www.specialty-online-pharmacy.blogspot.com""",
			"""https://www.ikopon.com""",
			"""https://www.ensourced.net"""] #define the start URL you want to start your crawl from
	#urls = [sys.argv[1]]
	pages = []
	...
	def start_requests(self):
		...
		#		print(url)
				yield scrapy.Request(url=url, 
					callback=self.parse, 
					dont_filter=True, 
					meta={"proxy": "http://172.16.238.7:7777"},
