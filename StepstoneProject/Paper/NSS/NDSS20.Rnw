...
<<Noevasion_4nodes, echo=FALSE, warning=FALSE, message=FALSE, fig.height=2.5,fig.width=8,fig.cap="ROC-curves for different SSD methods on dataset BA (no evasive tactics). Anomaly-based methods are excluded.",cache=TRUE>>=
require(ggplot2)
require(xtable)
...
<<Delaydetection, echo=FALSE, warning=FALSE,message=FALSE, fig.height=2.5,fig.width=8,fig.cap="Detection rates in dependence of $\\delta_D$ for different methods on dataset DA with a fixed FP rate of $0.4\\%$.",cache=TRUE>>=
require(ggplot2)
...
<<Chaffdetection, echo=FALSE, warning=FALSE,message=FALSE, fig.height=2.5,fig.width=8,fig.cap="Detection rates in dependence of $\\delta_C$ for different methods on dataset CA with a fixed FP rate of $0.4\\%$",cache=TRUE>>=
require(ggplot2)
