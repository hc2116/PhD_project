...
All of the above presented methods classify individual connections or pairs of connections as malicious or benign. As discussed by \textcolor{red}{insert citation}, true stepping stone connections are rare compared to benign ones. 
