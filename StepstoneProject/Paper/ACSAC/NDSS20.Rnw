...
\begin{align*}
\frac{\text{number of benign connections classified as malicious}}{overall number of benign connections},
\end{align*}

while the false negative rate is defined as

\begin{align*}
\frac{\text{number of malicious connections classified as benign}}{overall number of malicious connections}.
\end{align*}
